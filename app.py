...
def get_bot_response():
    ...
    print(userText)
    sentence = translator.translate(userText, src='mr', dest='en').text
    print("Input statement:", userText, translator.translate(
        userText, src='mr', dest='en'))
